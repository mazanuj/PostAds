...
namespace Motorcycle.Config.Data
{
    internal static class ReturnData
    {
        ...
        {
            ISiteData siteData = SiteDataFactory.GetSiteData(site);
        ...
        private static void FillReturnDataHoldersList(SiteEnum site, ProductEnum product, string textFile, ISiteData siteData)
        {
