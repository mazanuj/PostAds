namespace Motorcycle.Config.Proxy
{
    ...
    internal static class ProxyData
    {
        ...
        public static readonly int CountOfProxySites = 5;

        private static List<string> XroxyComData()
        {
            try
            {
        ...
        private static List<string> SocksProxyNetData()
        {
            try
            {
        ...
        private static List<string> LetUsHideComData()
        {
            try
            {
                var proxiesList = new List<string>();
        ...
        private static List<string> MyIpTestCom()
        {
            try
            {
                var downloadString =
        ...
        private static List<string> SpysRu()
        {
            try
            {
        ...
        public static List<string> GetProxyData()
        {
